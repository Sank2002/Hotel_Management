...
#price button
price_button = Button (label_frame_3, text="Price", borderwidth=5, padx=8, pady=6, command=on_click_price,font=('arial',12,'bold'))
price_button.grid(row=0,column=0, padx=20,pady=10)

# total button
total_button = Button (label_frame_3, text="Total", borderwidth=5, padx=8, pady=6, command=on_total,font=('arial',12,'bold'))
total_button.grid(row=0, column=1, padx=15)
# reset button

reset_button = Button (label_frame_3, text="Reset", borderwidth=5, padx=5, pady=6,font=('arial',12,'bold'),command=on_click_reset)
reset_button.grid(row=0, column=2, padx=15)

bill_button = Button (label_frame_3, text="Bill", borderwidth=5, padx=8, pady=6, font=('arial',12,'bold'),command=on_bill)
bill_button.grid(row=0, column=3, padx=15)

# quit button
quit_button = Button (label_frame_3, text="Quit", borderwidth=5, padx=8, pady=6, command=lambda : obj.destroy(),font=('arial',12,'bold'))
...
Button(calc_label_frame,text='7',width=4,height=2,bg='#072E33',fg="white",command=lambda : number(7)).grid(row=1,column=0)
Button(calc_label_frame,text='8',width=4,height=2,bg='#072E33',fg="white",command=lambda : number(8)).grid(row=1,column=1)
Button(calc_label_frame,text='9',width=4,height=2,bg='#072E33',fg="white",command=lambda : number(9)).grid(row=1,column=2)
Button(calc_label_frame,text='x',width=4,height=2,bg='#072E33',fg="white",command=lambda : number("*")).grid(row=1,column=3)
Button(calc_label_frame,text='4',width=4,height=2,bg='#072E33',fg="white",command=lambda : number(4)).grid(row=2,column=0)
Button(calc_label_frame,text='5',width=4,height=2,bg='#072E33',fg="white",command=lambda : number(5)).grid(row=2,column=1)
Button(calc_label_frame,text='6',width=4,height=2,bg='#072E33',fg="white",command=lambda : number(6)).grid(row=2,column=2)
Button(calc_label_frame,text='-',width=4,height=2,bg='#072E33',fg="white",command=lambda : number("-")).grid(row=2,column=3)
Button(calc_label_frame,text='1',width=4,height=2,bg='#072E33',fg="white",command=lambda : number(1)).grid(row=3,column=0)
Button(calc_label_frame,text='2',width=4,height=2,bg='#072E33',fg="white",command=lambda : number(2)).grid(row=3,column=1)
Button(calc_label_frame,text='3',width=4,height=2,bg='#072E33',fg="white",command=lambda : number(3)).grid(row=3,column=2)
Button(calc_label_frame,text='+',width=4,height=2,bg='#072E33',fg="white",command=lambda : number("+")).grid(row=3,column=3)
Button(calc_label_frame,text='C',width=4,height=2,bg='#072E33',fg="white",command=clear_number).grid(row=4,column=0)
Button(calc_label_frame,text='0',width=4,height=2,bg='#072E33',fg="white",command=lambda : number(0)).grid(row=4,column=1)
Button(calc_label_frame,text='=',width=4,height=2,bg='#072E33',fg="white",command=equal).grid(row=4,column=2)
Button(calc_label_frame,text='/',width=4,height=2,bg='#072E33',fg="white",command=lambda : number("/")).grid(row=4,column=3)
